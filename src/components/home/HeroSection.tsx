    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden gradient-hero pt-16">
        ...
        <div className="absolute bottom-40 left-[10%] glass-card p-4 float-delayed hidden lg:block">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium">14 days adventure</p>
            </div>
          </div>
        </div>
        ...
        <div className="absolute top-1/2 left-[8%] glass-card p-4 float-slow hidden xl:block">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-success">$2,400</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Headline */}
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-semibold leading-tight mb-6 animate-slide-up" style={{ animationDelay: "0.1s" }}>
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-slide-up" style={{ animationDelay: "0.2s" }}>
            ...
            GlobeTrotter makes travel planning effortless and delightful.
          </p>
